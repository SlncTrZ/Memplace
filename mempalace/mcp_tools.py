#!/usr/bin/env python3
"""
MemPalace MCP Tools — all tool definitions, handlers, and helpers.

Extracted from the monolith mcp_server.py. Contains ALL tool handler functions,
helper functions, module-level state, and the TOOLS dict. Imported by
mcp_server.py for JSON-RPC dispatch.
...
def tool_reconnect():
    ...
    # Drain the per-path KnowledgeGraph cache
    with _kg_cache_lock:
